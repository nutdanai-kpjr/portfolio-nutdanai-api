...
exports.checkJwt = jwt({
  secret: jwksRsa.expressJwtSecret({
    ...
    jwksUri: 'https://naidanut.jp.auth0.com/.well-known/jwks.json'
  }),
  audience: 'https://naidanut.jp.auth0.com/api/v2/',
  issuer: 'https://naidanut.jp.auth0.com/',
  algorithms: ['RS256']
});
...
exports.checkRole = role => (req, res, next) => {
  const user = req.user;
  console.log(user);
  console.log(config.AUTH0_NAMESPACE + '/roles');
